...
## [2026-08-27] refactor | Podar el vault a CIDP
- Borradas 19 páginas: los clusters de Tolosa-Hunt (9) y DAPT (9), que se unían al resto solo a través del índice, más la cola de ingesta de projects/.
- Reescritas [[Preguntas abiertas]] y [[Practica clinica en Chile]]: eran transversales y mezclaban los tres dominios; ahora solo CIDP.
- Los enlaces de esta bitácora a páginas eliminadas se degradaron a texto plano para no dejar nodos fantasma en el grafo; las entradas históricas se conservan.
- Resultado: 12 páginas, 0 enlaces rotos, 0 huérfanas; cada página con 3 a 10 enlaces entrantes desde contenido, ninguna colgando solo del índice.
- Las fuentes crudas de Tolosa-Hunt y DAPT siguen en projects/ del repo: se puede reingerir si hace falta (git revert de este commit devuelve las páginas).
